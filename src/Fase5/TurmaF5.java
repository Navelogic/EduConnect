...
public class TurmaF5 {
    private String codigoF4;
    private ProfessorF5 professorF4;
    private CursoF5 cursoF4;
    private List<AlunoF5> listaAlunosF4;

    public TurmaF5(String codigoF4, ProfessorF5 professorF4, CursoF5 cursoF4) {
    ...
    public void adicionarAluno(AlunoF5 aluno) {
        if (aluno != null) {
    ...
    public void removerAluno(AlunoF5 aluno) {
    ...
    public ProfessorF5 getProfessorF4() {
        return professorF4;
    }

    public void setProfessorF4(ProfessorF5 professorF4) {
        this.professorF4 = professorF4;
    }
    ...
    public List<AlunoF5> getListaAlunosF4() {
        return listaAlunosF4;
    }

    public void setListaAlunosF4(List<AlunoF5> listaAlunosF4) {
