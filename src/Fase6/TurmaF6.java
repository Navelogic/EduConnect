...
public class TurmaF6 {
    private String codigoF4;
    private ProfessorF6 professorF4;
    private CursoF6 cursoF4;
    private List<AlunoF6> listaAlunosF4;

    public TurmaF6(String codigoF4, ProfessorF6 professorF4, CursoF6 cursoF4) {
    ...
    public void adicionarAluno(AlunoF6 aluno) {
        if (aluno != null) {
    ...
    public void removerAluno(AlunoF6 aluno) {
    ...
    public ProfessorF6 getProfessorF4() {
        return professorF4;
    }

    public void setProfessorF4(ProfessorF6 professorF4) {
        this.professorF4 = professorF4;
    }
    ...
    public List<AlunoF6> getListaAlunosF4() {
        return listaAlunosF4;
    }

    public void setListaAlunosF4(List<AlunoF6> listaAlunosF4) {
